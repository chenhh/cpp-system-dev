...
![簡單的電腦組成結構](<../.gitbook/assets/uefi\_abstraction-min (1).png>)
...
![UEFI架構](../.gitbook/assets/uefi\_arch-min.png)
...
![CSM](../.gitbook/assets/uefi\_csm-min.png)
...
![磁區(sector)，磁軌(track)，磁柱(cylinder)](../.gitbook/assets/chs-min.png)
...
![主分割槽與邏輯分割槽](../.gitbook/assets/primary\_partition-min.png)
...
![MBR與GPT結構](../.gitbook/assets/differenace-mbr-gpt1-min.png)
