...
![UDP封包](../.gitbook/assets/UDP\_encapsulation.png)
...
![IPv4 class](../.gitbook/assets/IP\_class-min.png)
...
![IP封包參考MTU切割後，以ID重組](../.gitbook/assets/IP\_fragement-min.png)
...
![IPv4封包表頭，通常為20 bytes](../.gitbook/assets/ipv4\_packet-min.png)
