...
![真實模式記憶體配置](../.gitbook/assets/real\_mode\_memory\_allocation-min.png)
...
![mbr.raw的內容](../.gitbook/assets/mbr\_raw-min.png)
...
![QEMU執行mbr.raw的結果](../.gitbook/assets/qemu\_mbr\_hello-min.png)
...
![段描述子結構](../.gitbook/assets/segment\_descriptor.gif)

![段選擇子結構](../.gitbook/assets/segment\_selector.gif)
