...
![python thread狀態轉移圖](../.gitbook/assets/python\_thread\_state-min.png)
...
* [Python並行編程(python parallel programming cookbook) 中文版](https://python-parallel-programmning-cookbook.readthedocs.io/zh\_CN/latest/index.html)
