...
Rust宣稱的優點是“無GC的記憶體安全”，那麼陣列越界會直接導致程式崩潰這件事情是否意味著Rust不夠安全呢？不能這麼理解。Rust保證的“記憶體安全”，並非意味著“永不崩潰”。**Rust中關於陣列越界的行為，定義得非常清晰。相比於C/C++，Rust消除的是“未定義行為”（Undefined Behaviour）。**
